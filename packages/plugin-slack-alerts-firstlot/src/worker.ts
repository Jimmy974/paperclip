...
const COMPANY_ID = "47b2c30b-d789-4866-9758-bf4ee46ddb4d";
const COMPANY_NAME = "Firstlot";
...
async function postSlack(
  ...
  if (!webhookUrl) {
    ctx.logger.warn(
      "Slack webhook URL not configured. POST /plugins/@paperclipai/plugin-slack-alerts-firstlot/configure to set it.",
    );
    return;
  }
