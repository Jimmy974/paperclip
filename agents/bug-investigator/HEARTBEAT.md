...
4. If no clear match, default to `custom:portal2` + ask board user
...
## 8. Store
- `memory_store(scope="custom:portal2-bugs")` -- save durable findings: root causes, recurring patterns, scope-to-area mappings.
